...
module SongAiHandlers =
    ...
    let private generateMidiSystemPrompt =
        ...
        + "- ゆっくりとしたダイナミクス変化\n\n"
        + "絶対に守るべきルール:\n"
        + "1. コード進行のハーモニーに100%正確に従う。各小節で指定されたコードの構成音のみを使用すること\n"
        + "   例: Am7の小節ではA,C,E,Gのみ使用。間違った音は絶対に出さない\n"
        + "2. スタイル別ノート密度の目安:\n"
        ...
        + "重要: ピアノのバラード・弾き語り系スタイルでは、必ずCC64ペダルイベントを含めてください。\n"
        + "例: {\"t\": 0, \"cc\": 64, \"v\": 127}, {\"t\": 1900, \"cc\": 64, \"v\": 0}, {\"t\": 1920, \"cc\": 64, \"v\": 127}"
