...
module SongAiHandlers =
    ...
    let private generateMidiSystemPrompt =
        ...
        + "  45=Low Tom, 47=Low-Mid Tom, 48=Hi-Mid Tom, 50=High Tom\n"
        + "  37=Side Stick, 39=Hand Clap, 56=Cowbell\n"
        + "- ジャズブラシ: ライド(51)をメインに、ハイハット(42/46)でアクセント、スネア(38)は2&4拍目\n"
        + "- ロック/ポップ: キック(36)+スネア(38)+ハイハット(42)の基本パターン。フィルはタム(45,47,48)\n"
        + "- ファンク: キック(36)のシンコペーション、ゴーストスネア(38,v=25-35)、オープンハイハット(46)\n"
        + "- ブラシ: サイドスティック(37)を多用。全体的にvel=25-50の繊細なタッチ\n\n"
        + "絶対に守るべきルール:\n"
        ...
        + "注意: 1つのブロック内でスタイルを大きく変化させる指示（例:「前半バラード、後半アップテンポ」）の場合:\n"
        + "- 前半と後半で明確にノート密度とベロシティを変える\n"
        + "- 前半: 指示の静かな部分 → 少ないノート数、低いベロシティ\n"
        + "- 後半: 指示の激しい部分 → 多いノート数、高いベロシティ\n"
        + "- 全ノートを0にしたり、データを出力しないことは絶対に禁止\n\n"
        ...
        + "参考パターン例（2小節フレーズ）:\n\n"
        + "【弾き語りピアノバラード（Am7→Dm7, BPM 72）】\n"
        + "// Bar 1 (Am7): 左手ルート+5度のアルペジオ、右手は分散和音から始まり上昇\n"
        + "L: A2(t=0,d=960,v=68) E3(t=480,d=480,v=62) A2(t=960,d=480,v=65) E3(t=1440,d=480,v=60)\n"
        + "R: C4(t=0,d=480,v=65) E4(t=240,d=240,v=58) G4(t=480,d=720,v=70) A4(t=1200,d=480,v=62) E4(t=1680,d=240,v=55)\n"
        + "// Bar 2 (Dm7): フレーズが前小節から自然に続く。ベロシティが少し上がる\n"
        + "L: D3(t=1920,d=960,v=70) A3(t=2400,d=480,v=64) D3(t=2880,d=480,v=67) A3(t=3360,d=480,v=62)\n"
        + "R: F4(t=1920,d=480,v=68) A4(t=2160,d=240,v=60) D5(t=2400,d=720,v=72) C5(t=3120,d=480,v=65) A4(t=3600,d=320,v=58)\n"
        + "→ 左手はルート+5度の交互パターン、右手は小節をまたいでメロディが流れる\n\n"
        + "【ファンクギター16ビート（E7, BPM 110）1小節】\n"
        + "// 16ビートのアクセントパターン: x=mute(v=28,d=40), ↓=down(v=88,d=80), ↑=up(v=75,d=60)\n"
        + "// Pattern: x x ↓ x | x ↑ x ↓ | x x ↓ x | ↑ x ↓ ↑\n"
        + "// 各ストロークは E4,G#4,B4,D5 の4音を 4tickずつずらす\n"
        + "beat1: E4(t=0,d=40,v=28) G#4(t=4,d=40,v=26) B4(t=8,d=40,v=28) D5(t=12,d=40,v=25)  // mute\n"
        + "       E4(t=120,d=40,v=30) G#4(t=124,d=40,v=28) B4(t=128,d=40,v=30) D5(t=132,d=40,v=27)  // mute\n"
        + "       E4(t=240,d=80,v=88) G#4(t=244,d=80,v=85) B4(t=248,d=80,v=88) D5(t=252,d=80,v=83)  // DOWN accent\n"
        + "→ ミュートは極短duration(40)+低velocity(25-30)、アクセントは長めduration(80)+高velocity(85-90)\n\n"
        + "【ウォーキングベース（Dm7→G7, BPM 120）2小節】\n"
        + "// Bar 1 (Dm7): ルートから始まり、コードトーンで上行、最後にG7へのアプローチ\n"
        + "D2(t=0,d=420,v=85) F2(t=480,d=420,v=78) A2(t=960,d=420,v=80) F#2(t=1440,d=420,v=82)  // F#はG7へのアプローチ\n"
        + "// Bar 2 (G7): ルートから始まり、下行パターン\n"
        + "G2(t=1920,d=420,v=85) F2(t=2400,d=420,v=78) D2(t=2880,d=420,v=80) B1(t=3360,d=420,v=82)\n"
        + "→ 各小節の最後の音は次のコードのルートへの半音アプローチ\n\n"
        + "【ジャズドラム（4ビートスウィング, BPM 140）1小節】\n"
        + "Ride51(t=0,d=120,v=75) HH42(t=0,d=60,v=35)\n"
        + "Ride51(t=480,d=120,v=65)\n"
        + "Ride51(t=720,d=120,v=75) Snare38(t=960,d=120,v=55)  // 2拍目スネア\n"
        + "Ride51(t=960,d=120,v=70) HH42(t=960,d=60,v=30)\n"
        + "Ride51(t=1440,d=120,v=65)\n"
        + "→ ライドはスウィングの3連符感（1拍目と3連符の3つ目）。スネアは2&4拍。HHはゴーストで"
