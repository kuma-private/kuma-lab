// Edge cases for replaceAutomationRange:
//  - empty replacement clears the range
//  - exclusive end-tick boundary

import { test, expect } from '../fixtures/full-stack';
import { callSongStore, readBridgeStore, readCurrentSong } from '../fixtures/window-stores';
import type { Song, SongListItem } from '../../src/lib/types/song';

const SONG_ID = 'song-replace-edge';
...
test.describe('replaceAutomationRange edge cases', () => {
	...
	test('empty replacement clears the in-range points', async ({ page, bridge }) => {
		...
		// Empty replacement on [100, 400) should drop ticks 100/200/300
		// and preserve 0 and 400 (400 is excluded by the exclusive end).
