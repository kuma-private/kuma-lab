// Drive the pan range input on a ChannelStrip and verify the songStore
...
test.describe('Channel strip pan input', () => {
	...
	test('changing the pan input pushes through to track.pan', async ({ page, bridge }) => {
