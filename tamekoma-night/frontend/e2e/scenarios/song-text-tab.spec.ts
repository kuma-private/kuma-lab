// Switching to the Text tab from a song page must not throw or blank
// the screen. Pairs with the Visualizer tab smoke test.

import { test, expect } from '../fixtures/full-stack';
import { readBridgeStore, readCurrentSong } from '../fixtures/window-stores';
import type { Song, SongListItem } from '../../src/lib/types/song';

const SONG_ID = 'song-text-tab';
...
test.describe('Song page Text tab', () => {
	...
	test('clicking the Text tab activates it without errors', async ({ page, bridge }) => {
